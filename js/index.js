...
function displayCount()
{
    ...
    for(var i=0;i<allData.length;i++)
    {
        count1+=allData[i].actuals.newCases;
        count2+=allData[i].actuals.newDeaths;
        count3+=allData[i].actuals.vaccinesDistributed;
        count4+=allData[i].actuals.vaccinationsCompleted;
    }
